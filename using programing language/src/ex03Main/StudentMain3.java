...
public class StudentMain3 {
	...
	public static void main(String[] args) {
		...
		sList.add(new Student2(name));
		sList.get(0).addSubject("국어", gugScore);
		sList.get(0).addSubject("영어", engScore);
		sList.get(0).addSubject("수학", mathScore);
